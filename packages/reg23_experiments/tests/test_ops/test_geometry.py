...
def test_plane_integrals():
    ...
    from_extension = reg23_core.radon3d(volume_data, voxel_spacing, phi_values, theta_values, r_values,
    ...
    phi_values, theta_values, r_values = torch.meshgrid(phi_values, theta_values, r_values)
    radon = reg23_core.radon3d(volume_data, voxel_spacing, phi_values, theta_values, r_values,
