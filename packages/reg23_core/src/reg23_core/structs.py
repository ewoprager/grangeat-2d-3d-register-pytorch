...
if torch.cuda.is_available():
    ...
    class CUDATexture2D:
        ...
        def __init__(self, tensor: torch.Tensor, address_mode_x: str, address_mode_y: str):
            self._internal = reg23_core.CUDATexture2DInternal(tensor, address_mode_x, address_mode_y)
    ...
    class CUDATexture3D:
        ...
        def __init__(self, tensor: torch.Tensor, address_mode_x: str, address_mode_y: str, address_mode_z: str):
            self._internal = reg23_core.CUDATexture3DInternal(tensor, address_mode_x, address_mode_y, address_mode_z)
