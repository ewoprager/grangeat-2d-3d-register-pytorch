...
def add_ct_fiducial_layer(*, ctx: AppContext, namespace: str | None = None) -> napari.layers.Layer | None:
    ...
    layer.my_plugin = _CTFiducialLayerManager(ctx=ctx, layer=layer, dadg_key=dadg_key, xray_uid_dadg_key=uid_dadg_key)
    return layer
