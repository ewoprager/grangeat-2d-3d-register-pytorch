...
def main():
    ...
    axes.plot(xs, ys_vnumel_resample,
              label="Linear fit: y = {:.2e}x + {:.2e}".format(lin_coeffs_vnumel_resample[0], lin_coeffs_vnumel_resample[1]))
    ...
    axes.plot(xs, ys_xnumel_resample,
              label="Linear fit: y = {:.2e}x + {:.2e}".format(lin_coeffs_xnumel_resample[0], lin_coeffs_xnumel_resample[1]))
