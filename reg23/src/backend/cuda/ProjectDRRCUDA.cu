...
__host__ at::Tensor ProjectDRR_CUDA(const at::Tensor &volume, const at::Tensor &voxelSpacing,
	...
	Texture3DCUDA inputTexture = Texture3DCUDA::FromTensor(volume, common.spacing);
	...
	Kernel_ProjectDRR_CUDA<<<gridSize, blockSize>>>(
		std::move(inputTexture), sourceDistance, common.lambdaStart, common.stepSize, common.samplesPerRay,
