...
#         for args in samples:
#             result = extension_test.ops.mymuladd(*args)
...
#             out = extension_test.ops.mymuladd(*args)
...
#         for args in samples:
#             opcheck(torch.ops.extension_test.mymuladd.default, args)
#
...
#         for args in samples:
#             result = args[-1]
#             extension_test.ops.myadd_out(*args)
...
#         samples.extend(self.sample_inputs(device, requires_grad=False))
#         for args in samples:
#             opcheck(torch.ops.extension_test.myadd_out.default, args)
#
#     def test_opcheck_cpu(self):
#         self._opcheck("cpu")
#
